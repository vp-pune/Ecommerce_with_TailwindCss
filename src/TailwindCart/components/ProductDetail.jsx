...
function ProductDetail({ product }) {
    ...
    const handleCart = (product, check = '') => {
        const cart = JSON.parse(localStorage.getItem('cart')) || [];
        const singleCart = cart.find((item) => item.id === product.id);
        if (singleCart) {
                    ...
                    <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                        ...
                        <div className="flex justify-between">
                            ...
                            <div className="flex gap-5">
                                <button onClick={() => handleCart(product, 'buy')} className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 rounded">Buy Now</button>
