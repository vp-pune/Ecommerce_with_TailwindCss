                    ...
                    <div className="mx-auto max-w-5xl">
                        ...
                        <div className="mt-6 sm:mt-8 lg:flex lg:items-start lg:gap-12">
                            <form action="#" className="w-full rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800 sm:p-6 lg:max-w-xl lg:p-8">
                                ...
                                <button className="w-full mt-4 rounded-full bg-gradient-to-r from-blue-500 to-indigo-500 py-3 text-lg font-semibold text-white shadow-lg transition duration-300 ease-in-out hover:bg-gradient-to-l hover:from-indigo-500 hover:to-blue-500 focus:ring-4 focus:ring-indigo-300 dark:focus:ring-indigo-800">
                                    Proceed To Buy
                                </button>
