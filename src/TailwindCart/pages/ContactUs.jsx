...
function ContactUs() {
  ...
  const handleMessageSubmit = (e) => {
    e.preventDefault();
    const updatedMessages = [...messages, comment];
    ...
    <section className="text-gray-600 body-font relative">
      <div className="container px-3 py-24 mx-auto">
        <div className="flex flex-col text-center w-full mb-12">
          ...
          <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Tell Us More About Our Products...</p>
        </div>
        <form onSubmit={handleMessageSubmit} className="lg:w-1/2 md:w-2/3 mx-auto">
